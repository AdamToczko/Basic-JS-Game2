export default class Snake {
    constructor(scene) {
        ...
        this.body.push(this.scene.add.rectangle(0,0,16,16,0xff0000).setOrigin(0)); // head
        this.body.push(this.scene.add.rectangle(0,0,16,16,0x0000ff).setOrigin(0)); //body
